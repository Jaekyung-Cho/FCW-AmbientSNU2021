...
//            System.out.printf("%d %d\n", width, height);
            bitmap = Bitmap.createBitmap(rawbitmap, 0, 84, 640, 192);
            bitmap = Bitmap.createScaledBitmap(bitmap, 640, 192, true);
            //Input Tensor
            ...
            Bitmap depthbitmap = arrayFlotToBitmap(deptharray, 640, 192);

//            Bitmap finaldepthbitmap = Bitmap.createScaledBitmap(depthbitmap, width, height,true);
            Bitmap finaldepthbitmap = Bitmap.createScaledBitmap(depthbitmap, 640, 192, true);
...
//        System.out.printf("%d,%d\n",raw_width,raw_height);
        for(int u=0; u<raw_width; u++){
            for(int v=0; v<raw_height; v++){
                ...
                // only use x,z
                int x = (int)(xyz[0]*100), z = (int)(xyz[2]*100); // m -> cm
//                System.out.printf("%d %d\n", x, z);
